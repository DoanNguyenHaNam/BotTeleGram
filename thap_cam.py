...
if RESET:
    ...
    def fix_ef_infos(a,nh,ID):
        ...
        return a
    def mod_ef_sound(a,nh,ID,file,folder_mod=folder_mod):
        z=[]
        nh=bytes(nh,'utf-8')
        str1 = b"hero_skill_effects/" + nh.lower() + b"/"
        str2 = b"hero_skill_effects/" + nh + b"/"
        ...
        if (ID == b'51504' and file in ['A1.xml', 'A2.xml', 'A3.xml', 'A4.xml', 'A5.xml', 'S1.xml', 'S11.xml', 'S12.xml', 'S21B0.xml', 'S21B5.xml', 'S2B0.xml', 'S2B1.xml', 'S2B5.xml', 'U1B0.xml']) or (ID == b'11107' and 'E' not in file and 'eath' not in file)  or (ID == b'12304' and 'E' not in file) or (ID == b'15704' and file in ['S1.xml','A1.xml','A3.xml','A4.xml','S2.xml','U1.xml']):
            ...
            for code in split_code_clipname(a):
                ...
                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','rb') as f:
                    dance = f.read()
                    dance = dance.replace(b'  </Action>',code+b'  </Action>')
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','wb') as f1:
                        f1.write(dance)
    ...
    def tao(folder_mod):
        if True:
            ...
            for fo in ['commonresource','KeySpell','PassiveResource','mowen','Ultrafire']:
                ...
                inp2=f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/'
            ...
            os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
            ...
            for file in name:
                    try:    
                        with open(f'./Pmin_Sources/Resources/1.57.1/Databin/Client/{data}/{file}','rb') as f:
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/{data}/{file}','wb') as f1:
                                f1.write(strin)
                    except:
                            pass
        return back_need_
    ...
    for skinid in txt:
        if "%" in skinid:
            ...
            ten_de_vao_ten_dem+=1
            if True:
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                for filezz in listdir(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                    if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz)) == 0 :
                        os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz))
                if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
            ...
            #-----------------------------------------------Mod Effect------------------------------------------------------------#
                            ...
                            if filez=='skill' or filez=='Skill':
                                for file in listdir('./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                                    with open(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                        ...
                                        strin=mod_ef_sound(strin,hero_name.decode(),skinid,file)
                                        def split_code_resourceName(data):
                                            split_code = []
                                            start_tag = b'    <Track trackName='
                                            end_tag = b'  </Action>\r\n</Project'
                                            ...
                                            while start_pos != -1:
                                                ...
                                                if next_pos == -1:
                                                    ...
                                                    code = data[start_pos:next_pos].replace(end_tag, b'')
                                                if b'resourceName" value="' in code:
                                                    split_code.append(code)
                                                start_pos = next_pos

                                            return split_code
                                        for xml_bytes in split_code_resourceName(strin):
                                            xml_bytes2=xml_bytes
                                            import xml.etree.ElementTree as ET
                                            import random
                                            import string
                                            ...
                                            def modify_xml(xml_bytes):
                                                # Chuyển từ bytes sang chuỗi và parse XML
                                                xml_string = xml_bytes.strip().decode('utf-8')
                                                ...
                                                time = event.get("time") if event is not None else None
                                                length = event.get("length") if event is not None else None

                                                # Lấy resourceName
                                                resource_name_elem = root.find(".//String[@name='resourceName']")
                                                resource_name = resource_name_elem.get("value") if resource_name_elem is not None else ""

                                                # Tạo chuỗi ngẫu nhiên 16 ký tự
                                                random_string = generate_random_string()

                                                # Tạo XML mới theo yêu cầu
                                                new_root = ET.Element("Track", {
                                                    "trackName": "Zalo_0357514770",
                                                    "eventType": "GetHolidayResourcePathTick",
                                                    "guid": "Zalo_0357514770",
                                                    "enabled": "true",
                                                    "useRefParam": "false",
                                                    "refParamName": "",
                                                    "r": "0.000",
                                                ...
                                                # Thêm Condition nếu có
                                                for cond in conditions:
                                                    new_root.append(cond)

                                                # Tạo Event mới
                                                new_event = ET.SubElement(new_root, "Event", {
                                                    "eventName": "GetHolidayResourcePathTick",
                                                    "isDuration": "false",
                                                    "guid": "Zalo_0357514770"
                                                })

                                                # Thêm time và length nếu có
                                                if time:
                                                    new_event.set("time", time)
                                                if length:
                                                    new_event.set("length", length)

                                                # Thêm holidayResourcePathPrefix với giá trị resourceName
                                                ET.SubElement(new_event, "String", {
                                                    "name": "holidayResourcePathPrefix",
                                                    "value": resource_name,
                                                    "refParamName": "",
                                                    "useRefParam": "false"
                                                })

                                                # Thêm outPathParamName với chuỗi ngẫu nhiên
                                                ET.SubElement(new_event, "String", {
                                                    "name": "outPathParamName",
                                                    "value": random_string,
                                                    "refParamName": "",
                                                    "useRefParam": "false"
                                                })

                                                # Thêm outSoundEventParamName
                                                ET.SubElement(new_event, "String", {
                                                    "name": "outSoundEventParamName",
                                                    "value": "",
                                                    "refParamName": "",
                                                    "useRefParam": "false"
                                                })
                                                return resource_name,random_string,time,length,b''

                                            resource_name,random_string,time,length,conditions = modify_xml(xml_bytes[:-2])
                                            resource_name=resource_name.encode('utf-8')
                                            resource_name=fix_ef(resource_name,skinid)
                                            print(resource_name,random_string,conditions)
                                            Code_goc_de_all=b'<Track trackName="Zalo_0357514770" eventType="GetHolidayResourcePathTick" guid="Zalo_0357514770" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">CONDITION<Event eventName="GetHolidayResourcePathTick" TIME LENGTH isDuration="false" guid="Zalo_0357514770"><String name="holidayResourcePathPrefix" value="EFFECT" refParamName="" useRefParam="false" /><String name="outPathParamName" value="RANDOMCODE" refParamName="" useRefParam="false" /><String name="outSoundEventParamName" value="" refParamName="" useRefParam="false" /></Event></Track>\r\n  </Action>'
                                            if time:
                                                print('time:',time)
                                                time=b'time="' + time.encode('utf-8')+b'"'
                                            else:
                                                time=b''
                                            if length:
                                                print('length:',length)
                                                length=b'length="' + length.encode('utf-8')+b'"'
                                            else:
                                                length=b''
                                            p=xml_bytes.find(b'<Condition id="')
                                            if p!=-1:
                                                p2=xml_bytes.find(b'<Event eventName="',p)
                                                conditions=xml_bytes[p:p2].replace(
                                                    b'      ',b''
                                                ).replace(
                                                    b'\r\n',b''
                                                )
                                                ...
                                                conditions=b''
                                            for code in xml_bytes.split(b'\r\n'):
                                                if b'<String name="resourceName"' in code:
                                                    strin=strin.replace(
                                                        xml_bytes2,xml_bytes.replace(
                                                            code,b'<String name="resourceName" value="" refParamName="'+random_string.encode('utf-8')+b'" useRefParam="true" />'
                                                        ).replace(b'  ',b'')
                                                    )
                                                    break
                                            for i in range(1,20):
                                                i=b'0'*(2-len(str(i)))+str(i).encode('utf-8')
                                                strin=strin.replace(b'  </Action>',Code_goc_de_all.replace(
                                                    b'TIME',time
                                                ).replace(
                                                    b'LENGTH',length
                                                ).replace(
                                                    b'RANDOMCODE',random_string.encode('utf-8')
                                                ).replace(
                                                    b'EFFECT',resource_name.replace(
                                                        skinid,skinid[:3]+i
                                                    )
                                                ).replace(
                                                    b'CONDITION',conditions
                                                ))
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:
                                    ...
                                    if (skinid[:3]!=b'524' and file in ['A1E1.xml','A1e1.xml','a1e1.xml']) or (skinid[:3]==b'524' and file in ['A1E6.xml','A1e6.xml','a1e6.xml']):
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f1:
                                            strin=f1.read()
                                    ...
                                    if DeAllSkin:
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:f1.write(text)
                                if check_skill_an:
                                ...
                                for file in listdir(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}'):
                                    with open(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','rb') as f:
                                        strin = f.read()
                                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','wb') as f1:
                                                f1.write(strin)
                    else:
                        for file in listdir('./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                            if '.xml' in file:
                ...
                if hieu_ung == b'\x8f' and not DeAllSkin:
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:
                        strin=f1.read()
                    ...
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
                        f1.write(strin)
            #-----------------------------------------------Mod heroSkin------------------------------------------------------------#
                try:
                    if True:
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                if pos !=-1:
                                    ...
                                    if skinid==b'16707':
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            f1.write(strin)
                                    elif skinid==b'10620':
                                        actor_mod=actor_mod[:4]+actor_0[4:10]+actor_mod[10:36]+b'\x00'+actor_mod[37:]
                                ...
                                if pos !=-1:
                                    ...
                                    if re_2!=b'' and actor_2!=b'' and nnn!=int(skinid[3:].decode()):
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            f1.write(strin)
                        try:
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                                strin = f.read()
                                hero_actor=dec_to_hex(int(skinid[:3].decode()))
                                pos = strin.find(id_2+b'\x00\x00'+hero_actor)
                                if pos !=-1:
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','wb') as f1:
                                f1.write(strin)
                        except Exception as bug:
                            print(bug)          
                            pass
            ...
            #-----------------------------------------------Mod Infos Skin Mặc Định------------------------------------------------------------#
                for file in listdir('./Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/'.format(decompress)):
                    with open(f'./Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','rb') as f:
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','wb') as f1:
                            f1.write(a)
                thu=False
                try:
                    filexml='./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2)
                    byt=open(filexml, 'rb')
                    i=0
                    nod={}
                    ofs = getint()
                    ...
                    try:
                        with open(f'./Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file2}','rb') as f:
                            ...
                            if cam_skin_find!=-1:
                                ...
                                strin=strin.replace(mac_dinh,mac_dinh.replace(lod_mac_dinh,lod_skin).replace(show_mac_dinh,show_skin))
                            with open('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2),'wb') as f1:
                                if skinid==b'54402':
                ...
                try:
                    if check_file3:
                        filexml='./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file3)
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
            ...
            #---------------------------All Sound--------------------------
                if True:
                    ...
                    for nnn in range(1,30):
                        id_2 = dec_to_hex(int(skinid[:3].decode())*100+nnn)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/ChatSound.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/ChatSound.bytes','wb') as f:
                                    f.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/HeroSound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1 and id_2!=id_mod:
                                strin = strin.replace(b'\x00'+id_2+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/HeroSound.bytes','wb') as f:
                                    f.write(strin)  
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbyBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbyBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbySound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_2 + b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1 and id_2!=id_mod:
                                strin = strin.replace(b'\x00'+id_2+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbySound.bytes','wb') as f1:
                                    f1.write(strin)
            #-----------------------------------------------Mod HeroSkinShop------------------------------------------------------------#
                try:
                ...
                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                    ...
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f:f.write(a)
                try:
                #-----------------------------------------------Mod Sound------------------------------------------------------------#
                    if True:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            ...
                            if pos!=-1:
                                for file in listdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)):
                                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                        nam_tat = f.read()
                                        ...
                                        anti=nam_tat
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f:
            ...
            #-----------------------------------------------Mod Back------------------------------------------------------------#
                if find_back>2 or skinid in [b'15004',b'13311',b'16707']:
                    try:
                        ...
                        if True:
                            if True:
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
                                    strin = f.read()
                                    if True:
                                        ...
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','wb') as f1:
                                            f1.write(strin)
                        zz+=1;i+=1;j+=1
                    except Exception as bug:
                        print(bug)
            ...
            #-----------------------------------------------Mod LiteBullet------------------------------------------------------------#
                if skinid==b'15009':
                    for file in ['BlueBuff.xml','RedBuff_Slow.xml']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','rb') as f:
                            a=f.read()
                            a=a.replace(b'CheckSkinIdVirtualTick',b'CheckHeroIdTick').replace(b'skinId" value="15009',b'heroId" value="150')
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','wb') as f:
                            f.write(a)
    #------------------------mod ăn bùa nak----------------------
                if skinid==b'15013':
                    ...
                    for file in ['Dead_Born.xml']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','rb') as f:
                            a=f.read()
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','wb') as f:
                            f.write(a)
    #------------------------mod ăn bùa nak----------------------
                def mod_lite(folder_mod,hero_name,skinid):
                    try:
                        
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:
                            strin = f.read()
                            k=0
                                        ...
                                        if pos!=-1:
                                            ...
                                            if pos!=-1:
                                                ...
                                                if pos!=-1:
                                                    ...
                                                    a=a.replace(a,dau+a[1:])
                                                    strin = strin.replace(re_a,a)
                                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f1:
                                            f1.write(strin)
                                        k+=1
                    except:
                        print(Fore.RED+Style.BRIGHT+'Không Mod Đánh Thường'+Style.RESET_ALL)
                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:a=f.read()
                if b'/'+skinid[:3]+b'_' in a and hieu_ung==b'\x8f':
                    if skinid!=b'13311':
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f:f.write(a)
            #-----------------------------------------------Mod Skill Mark------------------------------------------------------------#
                try:
                    
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/skillmark.bytes','rb') as f:
                        a=f.read()
                        if b's/'+skinid[:3]+b'_' in a or b'S/'+skinid[:3]+b'_' in a:
                            a=skillmark(a,skinid)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/skillmark.bytes','wb') as f1:
                            f1.write(a)
                except:
                    print(Fore.RED+Style.BRIGHT+'Không Mod skillmark'+Style.RESET_ALL)
                if skinid==b'13311':
                    inp = f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/'
                ...
                try:
                    if True:
                        if skinid[:3] not in [b'150',b'106',b'131',b'510',b'136',b'524']:
                            DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                            DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                            nonee = './{}/skill'.format(decompress)
                            with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/Actor_{}_Actions.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        else:
                            def zipdir4(path, ziph):
                                for ii in listdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                                    nonee = f'./{decompress}/{ii}'
                                    DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                    DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in listdir(DIR2):
                                            ziph.write(os.path.join(root, file),
                                                    os.path.relpath(os.path.join(nonee,file),
                        ...
                        if skinid[:3]==b'526' or skinid[:3]==b'137':
                            os.mkdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}')
                            os.mkdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}_pet')
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}_pet/{decompress}_Pet_actorinfo.bytes','wb') as f:f.write(a)
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{decompress}_actorinfo.bytes','rb') as f:
                                a=f.read()
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}/{decompress}_actorinfo.bytes','wb') as f:
                                    f.write(a)
                            def zipdir3(path, ziph):
                                for ii in [decompress,f'{decompress}_pet']:
                                    nonee = './{}'.format(ii)
                                    DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in listdir(DIR2):
                                            ziph.write(os.path.join(root, file),
                                                    os.path.relpath(os.path.join(nonee,file),
                                                                    os.path.join(path, '..')))
                            with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,decompress[:3]), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir3('tmp/', zipf)
                            for file in listdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/'):
                                if 'bytes' not in file:
                                    shutil.rmtree(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{file}')
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            nonee = './Prefab_Hero/{}'.format(decompress)
                            with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))== 1 :
                            shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))== 1 :
                                shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                except:pass
            #----------------------------------Mod Motion--------------------------------------------#
                try:
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','rb') as f:
                        strin=f.read()
                        ID=skinid.decode()
                        List=[]
                        for i in range(30):
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','wb') as f:f.write(strin)
                except:
                    print('\033[1;33mKhong Mod Motion')
                if skinid in [b'54402']:
                    if os.path.isdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear')== 0 :
                        shutil.copytree(f'Pmin_sources/resources/1.57.1/ages/prefab_gear',f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear')
                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear/Defense/1338E1.xml','rb') as f:
                        strin=f.read()
                        strin=decompress_(strin,ZSTD_DICT)
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear/Defense/1338E1.xml','wb') as f:
                            f.write(fix_condition(strin))
                #----------------------------------Mod Haste--------------------------------------------#
                try:
                    if find_back>2:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f:
                            strin = f.read()
                            ...
                            if skinid==b'13210':
                                ef=ef.replace(b'CheckHeroIdTick',b'CheckSkinIdTick').replace(b'heroId" value="'+skinid[:3],b'skinId" value="'+skinid[:3]+b'00')
                            strin = strin.replace(b' </Action>',ef+b'\n  </Action>')
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
                                f1.write(strin)
                except:
                ...
                try:
                    if skinid[:3] in [b'150']:
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
                            killboard=f.read()
                        ...
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','wb') as f:
                            f.write(killboard)
                except Exception as bug:
                    print(bug)
                #Mod assetrefs
                ...
                try:
                    if DeAllSkin and hieu_ung==b'\x8f':   
                        fix_lag=0
                        for file in listdir('./Pmin_Sources/Resources/1.57.1/AssetRefs/Hero'):
                            if bytes(file[:3],'utf-8') == skinid[:3]:
                                with open(f'./Pmin_Sources/Resources/1.57.1/AssetRefs/Hero/{file}','rb') as f:
                                    strin = f.read()
                                    strin=decompress_(strin,ZSTD_DICT)
                                    #if skinid==b'13311':strin=strin.replace(b' hero_skill_effects/133_direnjie',b' component_effects/13311/13311_5')
                                    if os.path.isdir(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/') ==0:
                                        os.makedirs(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/')
                                        os.makedirs(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/')
                                    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}','wb') as f1:
                                        f1.write(strin)
                                        break
                        if hieu_ung==b'\x8f' :filexml=f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}'
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
                        ...
                        byt.close
                        xmlstr = minidom.parseString(ET.tostring(root)).toprettyxml(indent="   ")
                        xmlstr=xmlstr.replace('hero_skill_effects','Pmin_Mod_Vip').replace('Hero_Skill_Effects','Pmin_Mod_Vip')
                        with open(filexml, "w" , encoding="utf-8") as f:
                            f.write(xmlstr)
                        tree=ET.parse(filexml)
                        attr=b''
                    ...
                    if skinid==b'15009':
                        with open('organSkin.bytes','rb') as f:
                            a=f.read()
                        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/organSkin.bytes','wb') as f1:
                                    f1.write(a)
                except Exception as bug:
                    print(bug)
    def zipdir2(path, ziph):
        for ii in back_folder:
            nonee = './{}'.format(ii)
            DIR2 = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            DIR = './File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            for root, dirs, files in os.walk(DIR):
                for file in listdir(DIR2):
                    ziph.write(os.path.join(root, file),
                            os.path.relpath(os.path.join(nonee,file),
                                            os.path.join(path, '..')))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','rb') as f1:strin=f1.read()
    ...
    #with open(f'./Dance.xml','rb') as f1:strin=f1.read()
    #with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','wb') as f1:
    #    f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f1:strin=f1.read()
    if raz_15710_back:
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f1:strin=f1.read()
    if False:
    ...
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:strin=f1.read()
    strin=fix_condition(strin)
    with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with zipfile.ZipFile('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes'.format(folder_mod), 'w', zipfile.ZIP_STORED) as zipf:
        zipdir2('tmp/', zipf)
    ...
    for iii in back_folder:
        if os.path.isdir('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))== 1 :
            shutil.rmtree('./File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))
    #---------mod ResCharacterComponent.bytes-----
    try:
        with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Character/ResCharacterComponent.bytes','rb') as f:
            a=f.read()
            p2=a[:14]
            p3=a[:12]+b'\x00\x00'
            a=a.replace(p2,p3,1)
            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Character/ResCharacterComponent.bytes','wb') as f:f.write(compress_(a,ZSTD_DICT))
    except:
        print('\033[1;33mKhong Mod ResCharacterComponent.bytes')
    try:
        nut_bam=sys.argv[5]
        nut_bam=int(nut_bam)
        with open(f'File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResPersonalButtonCfg.bytes','rb') as f:
            a=f.read()
        ...
        with open(f'File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResPersonalButtonCfg.bytes','wb') as f:
            f.write(a)
        with open(f'File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
            a=f.read()
            inp=nut_bam
    ...
    if cam_xa_goc!=110:
        ...
        try:
            giai_nen(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/','Actor_530_Actions.pkg.bytes')
        except:
            shutil.copytree(f'Pmin_sources/resources/1.57.1/ages/Prefab_Characters/Prefab_Hero/530_Dirak',f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        ...
        giai_nen(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/','CommonActions.pkg.bytes')
        with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            p=a.find(b'    <Track trackName="')
            a=a[:p]+cam_xa
            with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        DIR = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        DIR2 = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        nonee = './530_Dirak/skill'
        with zipfile.ZipFile(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/Actor_530_Actions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir('tmp/', zipf)
        def zipdir_camxa(path, ziph):
            for ii in back_folder:
                nonee = './{}'.format(ii)
                DIR2 = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                DIR = f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                for root, dirs, files in os.walk(DIR):
                    for file in listdir(DIR2):
                        ziph.write(os.path.join(root, file),
                                os.path.relpath(os.path.join(nonee,file),
                                                os.path.join(path, '..')))
        with zipfile.ZipFile(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir_camxa('tmp/', zipf)
        if os.path.isdir(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')== 1 :
            shutil.rmtree(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        for iii in back_folder:
            if os.path.isdir(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')== 1 :
                shutil.rmtree(f'./File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')