                ...
                if skinid in [b'54402']:
                    try:
                        with open('Prefab_Gear.pkg.bytes','rb') as f:
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear.pkg.bytes','wb') as f1:
                                f1.write(f.read())
                    except:
                    ...
                    if skinid==b'52414':   
                        ...
                        with open(f'./Pmin_Sources/Resources/1.57.1/AssetRefs/Hero/{file}','rb') as f:
                            ...
                            with open(f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}','wb') as f1:
                                f1.write(strin)
                        filexml=f'./File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}'
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
