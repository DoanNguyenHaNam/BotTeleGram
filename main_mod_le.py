...
if RESET:
    import shutil
    LIST=['./Pmin_Sources','com.garena.game.kgvn','dance.xml','organSkin.bytes','File_Mod_Mod_Le']
    for i in LIST:
        try:
            shutil.rmtree(i)
        except:
    ...
    def code_assetref(code,skinid):
        ...
        with open(f'./Pmin_Sources/Resources/1.57.1/AssetRefs/Hero/{skinid}_AssetRef.bytes','rb') as f:
            a=decompress_(f.read(),ZSTD_DICT)
            a=a.lower()
            if code in a:
                return True
    ...
    def mod_ef_sound(a,nh,ID,file,folder_mod):
        ...
        if (ID == b'51504' and file in ['A1.xml', 'A2.xml', 'A3.xml', 'A4.xml', 'A5.xml', 'S1.xml', 'S11.xml', 'S12.xml', 'S21B0.xml', 'S21B5.xml', 'S2B0.xml', 'S2B1.xml', 'S2B5.xml', 'U1B0.xml']) or (ID == b'11107' and 'E' not in file and 'eath' not in file)  or (ID == b'12304' and 'E' not in file) or (ID == b'15704' and file in ['S1.xml','A1.xml','A3.xml','A4.xml','S2.xml','U1.xml']):
            ...
            for code in split_code_clipname(a):
                ...
                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','rb') as f:
                    dance = f.read()
                    dance = dance.replace(b'  </Action>',code+b'  </Action>')
                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','wb') as f1:
                        f1.write(dance)
    ...
    def find_skin_A(skinid):
        ...
        txt=open('./Pmin_Sources/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb')
    ...
    def tao(folder_mod):
        if True:
            if os.path.isdir('./File_Mod_Mod_Le/') == 0 :
                os.mkdir('./File_Mod_Mod_Le/')
            if os.path.isdir('./File_Mod_Mod_Le/{}/'.format(folder_mod)) == 1 :
                shutil.rmtree('./File_Mod_Mod_Le/{}/'.format(folder_mod))
            if os.path.isdir('./File_Mod_Mod_Le/{}/'.format(folder_mod)) == 0 :
                os.mkdir('./File_Mod_Mod_Le/{}/'.format(folder_mod))
            shutil.copytree('com.garena.game.kgvn','File_Mod_Mod_Le/{}/com.garena.game.kgvn'.format(folder_mod))
            for fo in ['commonresource','KeySpell','PassiveResource','mowen','Ultrafire','SeasonPlay']:
                inp=f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/'
                inp2=f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/'
            ...
            os.mkdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
        ...
        for data in databin:
            for file in name:
                    try:    
                        with open(f'./Pmin_Sources/Resources/1.57.1/Databin/Client/{data}/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/{data}/{file}','wb') as f1:
                                f1.write(strin)
                    except:
                            pass
        return back_need_
    ...
    for skinid in txt:
        if "%" in skinid:
            ...
            if b'rt' in skinid or b'RT' in skinid:
                ...
                skinid=skinid[:5]
            for hero_name in listdir('./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/'):
            ...
            ten_de_vao_ten_dem+=1
            if True:
                if os.path.isdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod)) == 0 :
                    os.mkdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                if os.path.isdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                for filezz in listdir(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                    if os.path.isdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz)) == 0 :
                        os.mkdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz))
                if os.path.isdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
            ...
            #-----------------------------------------------Mod Effect------------------------------------------------------------#
                if True:
                    ...
                    if hieu_ung == b'\x8f':
                        ...
                        for filez in listdir(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}'):
                            if filez=='skill' or filez=='Skill':
                                for file in listdir('./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                                    if True:
                                        try:
                                            ...
                                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:
                                                    f1.write(strin)
                                        except:
                                            with open(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                                strin = f.read()
                                                strin=decompress_(strin,ZSTD_DICT)
                                                if '_back.xml' in file or '_Back.xml' in file:
                                                    strin=strin.replace(b'enabled="true"',b'enabled="false"')
                                    ...
                                    if (skinid[:3]!=b'524' and file in ['A1E1.xml','A1e1.xml','a1e1.xml']) or (skinid[:3]==b'524' and file in ['A1E6.xml','A1e6.xml','a1e6.xml']):
                                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f1:
                                            strin=f1.read()
                                            p=strin.find(b'<String name="resourceName" value="')
                                            while p!=-1:
                                                p2=strin.find(b'" refParamName=""',p)
                                    ...
                                    if DeAllSkin:
                                        ...
                                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:f1.write(text)
                                if check_skill_an:
                                    ten_de_vao_skill_an=ten_de_vao_skill_an+decompress+'\n'
                                    for i in list_skill_an:
                                        ten_de_vao_skill_an=ten_de_vao_skill_an+'\t'+i+'\n'
                            else:
                                for file in listdir(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}'):
                                    with open(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','rb') as f:
                                        strin = f.read()
                                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','wb') as f1:
                                                f1.write(strin)
                    else:
                        for file in listdir('./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                            if '.xml' in file:
                                with open(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                    ...
                                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:
                                        f1.write(strin)
                #--------------Mod Born--------------------
                if hieu_ung == b'\x8f' and not DeAllSkin and skinid not in [b'11120',b'13706']:
                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:
                        strin=f1.read()
                    ...
                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
                        f1.write(strin)
            #-----------------------------------------------Mod heroSkin------------------------------------------------------------#
                try:
                    if True:
                        ...
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                if pos !=-1:
                                    ...
                                    if skinid==b'16707':
                                        ...
                                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            f1.write(strin)
                                    elif skinid==b'10620':
                                        actor_mod=actor_mod[:4]+actor_0[4:10]+actor_mod[10:36]+b'\x00'+actor_mod[37:]
                                ...
                                if pos !=-1:
                                    ...
                                    if re_2!=b'' and actor_2!=b'' and nnn!=int(skinid[3:].decode()):
                                        ...
                                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            f1.write(strin)
                        try:
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                                strin = f.read()
                                hero_actor=dec_to_hex(int(skinid[:3].decode()))
                                pos = strin.find(id_2+b'\x00\x00'+hero_actor)
                                if pos !=-1:
                                    ...
                                    if pos!=-1:
                                        ...
                                        if skinid==b'13311':
                                            with open(f'./Pmin_Sources/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                            ...
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','wb') as f1:
                                f1.write(strin)
                        except Exception as bug:
                            print(bug)          
                            pass
            ...
            #-----------------------------------------------Mod Infos Skin Mặc Định------------------------------------------------------------#
                for file in listdir('./Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/'.format(decompress)):
                    with open(f'./Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','rb') as f:
                        a=f.read()
                        check_file3=False
                        ...
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','wb') as f1:
                            f1.write(a)
                thu=False
                try:
                    filexml='./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2)
                    byt=open(filexml, 'rb')
                    i=0
                    nod={}
                    ofs = getint()
                ...
                if thu:
                    try:
                        with open(f'./Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file2}','rb') as f:
                            strin=f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            ...
                            if cam_skin_find!=-1:
                                ...
                                strin=strin.replace(mac_dinh,mac_dinh.replace(lod_mac_dinh,lod_skin).replace(show_mac_dinh,show_skin))
                            with open('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2),'wb') as f1:
                                if skinid==b'54402':
                ...
                try:
                    if check_file3:
                        filexml='./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file3)
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
            ...
            #---------------------------All Sound--------------------------
                if True:
                    ...
                    for nnn in range(1,30):
                        id_2 = dec_to_hex(int(skinid[:3].decode())*100+nnn)
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/ChatSound.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/ChatSound.bytes','wb') as f:
                                    f.write(strin)
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/HeroSound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1 and id_2!=id_mod:
                                strin = strin.replace(b'\x00'+id_2+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/HeroSound.bytes','wb') as f:
                                    f.write(strin)  
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbyBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbyBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbySound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_2 + b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1 and id_2!=id_mod:
                                strin = strin.replace(b'\x00'+id_2+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbySound.bytes','wb') as f1:
                                    f1.write(strin)
            #-----------------------------------------------Mod HeroSkinShop------------------------------------------------------------#
                try:
                ...
                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                    ...
                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f:f.write(a)
                try:
                #-----------------------------------------------Mod Sound------------------------------------------------------------#
                    if True:
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            ...
                            if pos!=-1:
                                for file in listdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)):
                                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                        nam_tat = f.read()
                                        ...
                                        anti=nam_tat
                                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f:
            ...
            #-----------------------------------------------Mod Back------------------------------------------------------------#
                if (find_back>2 or skinid in [b'15004',b'13311',b'16707']) and skinid not in [b'11120',b'13706']:
                    try:
                        name = b''
                        for file in listdir('./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(decompress)):
                            with open(f'./Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                        ...
                        if True:
                            if True:
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
                                    strin = f.read()
                                    if True:
                                        ...
                                        '''if List_skinor_back==[]:
                                            p=back_need_.find(b'<SkinOrAvatarList id="')
                                            
                                            while p!=-1:
                                                p2=back_need_.find(b'" />',p)
                                                if back_need_[p+len(b'<SkinOrAvatarList id="'):p2] not in List_skinor_back:
                                                    List_skinor_back.append(back_need_[p+len(b'<SkinOrAvatarList id="'):p2])
                                                p=back_need_.find(b'<SkinOrAvatarList id="',p2)
...
'''
                                        ...
                                        elif skinid in List_skinor_back and False:
                                            strin=strin.replace(b'<Event eventName="PlayAnimDuration"',condition_mod_false+b'\r\n      <Event eventName="PlayAnimDuration"',3)
                                            back_need_2=b'''\n    <Track trackName="PlayAnimDuration0" eventType="PlayAnimDuration" guid="664523ad-bc5e-4796-94a7-003b758fb8c4" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" SkinAvatarFilterType="11">
    ...
    <Track trackName="PlayAnimationTick0" eventType="PlayAnimationTick" guid="bf5371fe-9e4e-4d7c-b394-33ec1966f052" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" SkinAvatarFilterType="11">
      <Event eventName="PlayAnimationTick" time="0.000" isDuration="false" guid="739721fb-796e-45f1-9b57-aacd6e963bac">
        <TemplateObject name="targetId" objectName="self" id="0" isTemp="false" refParamName="" useRefParam="false" />
    ...
    <Track trackName="PlayAnimDuration2" eventType="PlayAnimDuration" guid="972d1382-031a-4c10-8eeb-d10b3fc76f47" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" SkinAvatarFilterType="11">
      <Event eventName="PlayAnimDuration" time="7.000" length="1.500" isDuration="true" guid="620b137f-72fa-4602-a653-72ae85944d33">
        ...
        <bool name="alwaysAnimate" value="true" refParamName="" useRefParam="false" />
                                            ...
                                            back_need_2=back_need_2.replace(b'clipName" value="',b'clipName" value="'+skinid+b'/')
                                        else:back_need_2=b''
                                        ...
                                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','wb') as f1:
                                            f1.write(strin)
                        zz+=1;i+=1;j+=1
                    except Exception as bug:
                        print(bug)
            ...
            #-----------------------------------------------Mod LiteBullet------------------------------------------------------------#
                if skinid==b'15009':
                    for file in ['BlueBuff.xml','RedBuff_Slow.xml']:
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','rb') as f:
                            a=f.read()
                            a=a.replace(b'CheckSkinIdVirtualTick',b'CheckHeroIdTick').replace(b'skinId" value="15009',b'heroId" value="150')
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','wb') as f:
                            f.write(a)
    #------------------------mod ăn bùa nak----------------------
                if skinid==b'15013':
                    ...
                    for file in ['Dead_Born.xml']:
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','rb') as f:
                            a=f.read()
                        ...
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','wb') as f:
                            f.write(a)
    #------------------------mod ăn bùa nak----------------------
                def mod_lite(folder_mod,hero_name,skinid):
                    try:
                        
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:
                            strin = f.read()
                            k=0
                                        ...
                                        if pos!=-1:
                                            ...
                                            if pos!=-1:
                                                ...
                                                if pos!=-1:
                                                    ...
                                                    a=a.replace(a,dau+a[1:])
                                                    strin = strin.replace(re_a,a)
                                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f1:
                                            f1.write(strin)
                                        k+=1
                    except:
                        print(Fore.RED+Style.BRIGHT+'Không Mod Đánh Thường'+Style.RESET_ALL)
                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:a=f.read()
                if b'/'+skinid[:3]+b'_' in a and hieu_ung==b'\x8f':
                    if skinid!=b'13311':
                        ...
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f:f.write(a)
            #-----------------------------------------------Mod Skill Mark------------------------------------------------------------#
                try:
                    
                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/skillmark.bytes','rb') as f:
                        a=f.read()
                        if b's/'+skinid[:3]+b'_' in a or b'S/'+skinid[:3]+b'_' in a:
                            a=skillmark(a,skinid)
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/skillmark.bytes','wb') as f1:
                            f1.write(a)
                except:
                    print(Fore.RED+Style.BRIGHT+'Không Mod skillmark'+Style.RESET_ALL)
                if skinid==b'13311':
                    inp = f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/'
                ...
                try:
                    if True:
                        if skinid[:3] not in [b'150',b'106',b'131',b'510',b'136',b'524']:
                            DIR = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                            DIR2 = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                            nonee = './{}/skill'.format(decompress)
                            with zipfile.ZipFile('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/Actor_{}_Actions.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        else:
                            def zipdir4(path, ziph):
                                for ii in listdir(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                                    nonee = f'./{decompress}/{ii}'
                                    DIR = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                    DIR2 = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in listdir(DIR2):
                                            ziph.write(os.path.join(root, file),
                                                    os.path.relpath(os.path.join(nonee,file),
                        ...
                        if skinid[:3]==b'526' or skinid[:3]==b'137':
                            os.mkdir(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}')
                            os.mkdir(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}_pet')
                            with open(f'./Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Pet/{decompress}_Pet/{decompress}_Pet_actorinfo.bytes','rb') as f:a=f.read()
                            if skinid[:3]==b'526':
                                a=decompress_(a,ZSTD_DICT)
                            ...
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}_pet/{decompress}_Pet_actorinfo.bytes','wb') as f:f.write(a)
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{decompress}_actorinfo.bytes','rb') as f:
                                a=f.read()
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}/{decompress}_actorinfo.bytes','wb') as f:
                                    f.write(a)
                            def zipdir3(path, ziph):
                                for ii in [decompress,f'{decompress}_pet']:
                                    nonee = './{}'.format(ii)
                                    DIR2 = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    DIR = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in listdir(DIR2):
                                            ziph.write(os.path.join(root, file),
                                                    os.path.relpath(os.path.join(nonee,file),
                                                                    os.path.join(path, '..')))
                            with zipfile.ZipFile('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,decompress[:3]), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir3('tmp/', zipf)
                            for file in listdir(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/'):
                                if 'bytes' not in file:
                                    shutil.rmtree(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{file}')
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            DIR = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            DIR2 = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            nonee = './Prefab_Hero/{}'.format(decompress)
                            with zipfile.ZipFile('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        if os.path.isdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))== 1 :
                            shutil.rmtree('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            if os.path.isdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))== 1 :
                                shutil.rmtree('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                except:pass
            #----------------------------------Mod Motion--------------------------------------------#
                try:
                    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','rb') as f:
                        strin=f.read()
                        ID=skinid.decode()
                        List=[]
                        for i in range(30):
                        ...
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','wb') as f:f.write(strin)
                except:
                    print('\033[1;33mKhong Mod Motion')
                if skinid in [b'54402']:
                    try:
                        with open('Prefab_Gear.pkg.bytes','rb') as f:
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear.pkg.bytes','wb') as f1:
                                f1.write(f.read())
                    except:
                        if os.path.isdir(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear')== 0 :
                            shutil.copytree(f'./Pmin_Sources/resources/1.57.1/ages/prefab_gear',f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear')
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear/Defense/1338E1.xml','rb') as f:
                            strin=f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            ...
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear/Defense/1338E1.xml','wb') as f:
                                f.write(fix_condition(strin))
                #----------------------------------Mod Haste--------------------------------------------#
                try:
                    if find_back>2 and skinid not in [b'11120',b'13706']:
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
                                    f1.write(strin)
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f:
                            strin = f.read()
                            ...
                            if skinid==b'13210':
                                ef=ef.replace(b'CheckHeroIdTick',b'CheckSkinIdTick').replace(b'heroId" value="'+skinid[:3],b'skinId" value="'+skinid[:3]+b'00')
                            strin = strin.replace(b' </Action>',ef+b'\n  </Action>')
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
                                f1.write(strin)
                except:
                ...
                try:
                    if skinid[:3] in [b'150']:
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
                            killboard=f.read()
                        ...
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','wb') as f:
                            f.write(killboard)
                except Exception as bug:
                    print(bug)
                #Mod assetrefs
                ...
                try:
                    if skinid==b'52414':   
                        ...
                        with open(f'./Pmin_Sources/Resources/1.57.1/AssetRefs/Hero/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            if os.path.isdir(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/') ==0:
                                os.makedirs(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/')
                                os.makedirs(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/')
                            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}','wb') as f1:
                                f1.write(strin)
                        filexml=f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}'
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
         ...
         <Item Var="Com" Type="AssetRefAnalyser.Pair`2[System.UInt32,System.Int32]">
            ...
            <v2 Var="String" Type="System.Int32">1</v2>
                        ...
                        f.close()
                    if skinid==b'15009':
                        with open('organSkin.bytes','rb') as f:
                            a=f.read()
                        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/organSkin.bytes','wb') as f1:
                                    f1.write(a)
                except Exception as bug:
                    print(bug)
    def zipdir2(path, ziph):
        for ii in back_folder:
            nonee = './{}'.format(ii)
            DIR2 = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            DIR = './File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            for root, dirs, files in os.walk(DIR):
                for file in listdir(DIR2):
                    ziph.write(os.path.join(root, file),
                            os.path.relpath(os.path.join(nonee,file),
                                            os.path.join(path, '..')))
    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','rb') as f1:strin=f1.read()
    ...
    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f1:strin=f1.read()
    if raz_15710_back:
    ...
    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f1:strin=f1.read()
    if False:
    ...
    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:strin=f1.read()
    strin=fix_condition(strin)
    with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with zipfile.ZipFile('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes'.format(folder_mod), 'w', zipfile.ZIP_STORED) as zipf:
        zipdir2('tmp/', zipf)
    ten_de_vao_ten=ten_de_vao_ten.encode('utf-8')
    with open(f'File_Mod_Mod_Le/{folder_mod}/list.txt','wb') as f:f.write(ten_de_vao_ten)

    ten_de_vao_skill_an=ten_de_vao_skill_an.encode('utf-8')
    with open(f'File_Mod_Mod_Le/{folder_mod}/skill_an(checkskinidtick).txt','wb') as f:f.write(ten_de_vao_skill_an)
    for iii in back_folder:
        if os.path.isdir('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))== 1 :
            shutil.rmtree('./File_Mod_Mod_Le/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))
    #---------mod ResCharacterComponent.bytes-----
    try:
        with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Character/ResCharacterComponent.bytes','rb') as f:
            a=f.read()
            p2=a[:14]
            p3=a[:12]+b'\x00\x00'
            a=a.replace(p2,p3,1)
            with open(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Character/ResCharacterComponent.bytes','wb') as f:f.write(compress_(a,ZSTD_DICT))
    except:
        print('\033[1;33mKhong Mod ResCharacterComponent.bytes')
    try:
        nut_bam=sys.argv[5]
        nut_bam=int(nut_bam)
        with open(f'File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResPersonalButtonCfg.bytes','rb') as f:
            a=f.read()
        ...
        with open(f'File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResPersonalButtonCfg.bytes','wb') as f:
            f.write(a)
        with open(f'File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
            a=f.read()
            inp=nut_bam
    ...
    if cam_xa_goc!=110:
        ...
        if os.path.isdir(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%') == 0 :
            os.mkdir(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%')
        shutil.copytree(f'./File_Mod_Mod_Le/{folder_mod}/com.garena.game.kgvn',f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn')
        try:
            giai_nen(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/','Actor_530_Actions.pkg.bytes')
        except:
            shutil.copytree(f'./Pmin_Sources/resources/1.57.1/ages/Prefab_Characters/Prefab_Hero/530_Dirak',f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        ...
        giai_nen(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/','CommonActions.pkg.bytes')
        with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            p=a.find(b'    <Track trackName="')
            a=a[:p]+cam_xa
            with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/back.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        DIR = f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        DIR2 = f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        nonee = './530_Dirak/skill'
        with zipfile.ZipFile(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/Actor_530_Actions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir('tmp/', zipf)
        def zipdir_camxa(path, ziph):
            for ii in back_folder:
                nonee = './{}'.format(ii)
                DIR2 = f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                DIR = f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                for root, dirs, files in os.walk(DIR):
                    for file in listdir(DIR2):
                        ziph.write(os.path.join(root, file),
                                os.path.relpath(os.path.join(nonee,file),
                                                os.path.join(path, '..')))
        with zipfile.ZipFile(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir_camxa('tmp/', zipf)
        if os.path.isdir(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')== 1 :
            shutil.rmtree(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        for iii in back_folder:
            if os.path.isdir(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')== 1 :
                shutil.rmtree(f'./File_Mod_Mod_Le/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')
