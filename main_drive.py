...
if RESET:
    import shutil
    LIST=['/content/drive/My Drive/tool/Pmin_Sources','com.garena.game.kgvn','dance.xml','organSkin.bytes','/content/drive/My Drive/tool/File_Mod']
    for i in LIST:
        try:
            shutil.rmtree(i)
        except:
    ...
    for inp in listdir('/content/drive/My Drive/tool/Pmin_Sources/Resources'):
        break
    def decompress_(strin,ZSTD_DICT=ZSTD_DICT):
        ...
        return strin
    if os.path.isdir('/content/drive/My Drive/tool/com.garena.game.kgvn/') == 0 :
        os.mkdir('/content/drive/My Drive/tool/com.garena.game.kgvn/')
        os.mkdir('/content/drive/My Drive/tool/com.garena.game.kgvn/files')
        os.mkdir('/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/')
        shutil.copytree( f'/content/drive/My Drive/tool/Pmin_Sources/Resources/{inp}/Ages',f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Ages')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Actor')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Huanhua')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Character')
        with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/{inp}/Databin/Client/Character/ResCharacterComponent.bytes','rb') as f:
            a=decompress_(f.read(),ZSTD_DICT)
        with open(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Character/ResCharacterComponent.bytes','wb') as f:f.write(a)
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Motion')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Rank')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Shop')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Skill')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Databin/Client/Sound')
        os.mkdir(f'/content/drive/My Drive/tool/com.garena.game.kgvn/files/Resources/{inp}/Prefab_Characters/')
    ...
    t1=f'/content/drive/My Drive/tool/Pmin_Sources/Resources/{inp}/Ages/Prefab_Characters/Prefab_Hero/'
    t2=f'/content/drive/My Drive/tool/Pmin_Sources/Resources/{inp}/Prefab_Characters/'
    if os.path.isdir(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/{inp}/Ages/Prefab_Characters/Prefab_Hero/150_HanXin') == 0 :
        ...
        for file in listdir(t1):
            ...
            if file== 'CommonActions.pkg.bytes':
                print(giai_nen(t1,file),end='\r')
        print(giai_nen(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/{inp}/Ages/','Prefab_Gear.pkg.bytes'),end='\r')
    ...
    if HD_e=='' or 's' in HD_e or 'S' in HD_e:
        HD_e=True
        folder_mod=folder_mod+'_Chiêu_Siêu_Nét'
    else:
        HD_e=False
        folder_mod=folder_mod
    try:
        DeAllSkin=sys.argv[3]
    except:
        DeAllSkin='t'
    ...
    def code_assetref(code,skinid):
        ...
        with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/AssetRefs/Hero/{skinid}_AssetRef.bytes','rb') as f:
            a=decompress_(f.read(),ZSTD_DICT)
            a=a.lower()
            if code in a:
                return True
    ...
    def mod_ef_sound(a,nh,ID,file,folder_mod):
        ...
        if (ID == b'51504' and file in ['A1.xml', 'A2.xml', 'A3.xml', 'A4.xml', 'A5.xml', 'S1.xml', 'S11.xml', 'S12.xml', 'S21B0.xml', 'S21B5.xml', 'S2B0.xml', 'S2B1.xml', 'S2B5.xml', 'U1B0.xml']) or (ID == b'11107' and 'E' not in file and 'eath' not in file)  or (ID == b'12304' and 'E' not in file) or (ID == b'15704' and file in ['S1.xml','A1.xml','A3.xml','A4.xml','S2.xml','U1.xml']):
            ...
            for code in split_code_clipname(a):
                ...
                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','rb') as f:
                    dance = f.read()
                    dance = dance.replace(b'  </Action>',code+b'  </Action>')
                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Dance.xml','wb') as f1:
                        f1.write(dance)
        ...
        a=a.replace(b'<String name="resourceName"',b'<int name="frameRate" value="60" refParamName="" useRefParam="false" />\r\n        <String name="resourceName"')
        a=a.replace(b'<String name="clipName"',b'<int name="frameRate" value="60" refParamName="" useRefParam="false" />\r\n        <String name="clipName"')
        if ID[:3] == b'190':
            a=a.replace(b'Prefab_Skill_Effects/Hero_Skill_Effects/190_Zhugeliang/',b'Prefab_Skill_Effects/Hero_Skill_Effects/190_Zhugeliang/'+ID+b'/')
        return a
    ...
    def ten_skin_hieu_ung(skinid):
        with open('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
            a=f.read()
            ...
            if p!=-1:
                ...
                if b'Skin_' in code:
                    ...
                    h=b'PminMod'
                    with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                        a=f.read()
                        a=decompress_(a,ZSTD_DICT)
                        if bytes(str(skinid),'utf-8') in a:
                            h=b'\x8f'
                if skinid==13204 or skinid==53702 or skinid == 15305:h=b'\x8f'
        txt=open('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Languages/VN_Garena_VN/languageMap_Xls.txt','rb')
        a=txt.read()
        a=decompress_(a,ZSTD_DICT)
        txt=a.split(b'\r')
        '''p=a.find(ten)
        ...
        try:
            for i in txt:
                if ten in i:
                    a1=i[len(ten)+3:].decode()
                    break
            for i in txt:
                if skin in i:
                    a2=i[len(skin)+3:].decode()
                    break
        except:h=b'PminMod'
        try:
            b1=a1;b2=a2
    ...
    def find_skin_A(skinid):
        import re
        txt=open('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Languages/VN_Garena_VN/languageMap_Xls.txt','rb')
        a=txt.read();a=decompress_(a,ZSTD_DICT)
        txt=open('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb')
        b=txt.read();b=decompress_(b,ZSTD_DICT)
        z=[]
        for i in range(1,20):
            c=str(i)
            s=skinid[:3]+b'0'*(len(c)%2)+bytes(c,'utf-8')
            s1=s[:3]+bytes(str(i+1),'utf-8')
            p=b.find(dec_to_hex(int(s.decode()))+b'\x00\x00'+dec_to_hex(int(s[:3].decode())))
            if p!=-1:
                code=b[p-4:p+hex_to_dec(b[p-4:p-2])]
                if b'Skin_Icon_Skill' not in code:
                    d,e=ten_skin_hieu_ung(int(s.decode()))
                    check=re.sub(r"\s+", "", e)
                    if d!=b'\x8f' and '[ex]' not in e and len(check)>2:
                        print('\033[1;32m\nSkin Bac A:',e)
                        z.append(s1)
                        break
        if z==[]:
    ...
    def tao(folder_mod):
        if True:
            if os.path.isdir('/content/drive/My Drive/tool/File_Mod/') == 0 :
                os.mkdir('/content/drive/My Drive/tool/File_Mod/')
            if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/'.format(folder_mod)) == 1 :
                shutil.rmtree('/content/drive/My Drive/tool/File_Mod/{}/'.format(folder_mod))
            if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/'.format(folder_mod)) == 0 :
                os.mkdir('/content/drive/My Drive/tool/File_Mod/{}/'.format(folder_mod))
            shutil.copytree('/content/drive/My Drive/tool/com.garena.game.kgvn','/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn'.format(folder_mod))
            for fo in ['commonresource','KeySpell','PassiveResource','mowen','Ultrafire']:
                inp=f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/'
                inp2=f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/'
            ...
            os.mkdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
        databin = ['Sound','Actor','Skill','Shop','Motion','Huanhua']
        name = ['BattleBank.bytes','ChatSound.bytes','HeroSound.bytes','LobbyBank.bytes','LobbySound.bytes','heroSkin.bytes','HeroSkinShop.bytes','liteBulletCfg.bytes','skillmark.bytes','ResSkinMotionBaseCfg.bytes','ResKillBillboardCfg.bytes','ResPersonalButtonCfg.bytes']
        for data in databin:
            for file in name:
                    try:    
                        with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Databin/Client/{data}/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/{data}/{file}','wb') as f1:
                                f1.write(strin)
                    except:
                            pass
        return back_need_
    ...
    txt = open('/content/drive/My Drive/tool/list_mod.txt','r')
    ...
    for skinid in txt:
        if "%" in skinid:
            ...
            if b'rt' in skinid or b'RT' in skinid:
                ...
                skinid=skinid[:5]
            for hero_name in listdir('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/'):
                if '.rar' not in hero_name and '_' in hero_name:
                    ...
                    if skinid[:3]== hero_name[:3]:
                        ...
                        break
            hieu_ung,tat=ten_skin_hieu_ung(int(skinid.decode()))
            ...
            ten_de_vao_ten_dem+=1
            if True:
                if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod)) == 0 :
                    os.mkdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                for filezz in listdir(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                    if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz)) == 0 :
                        os.mkdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,filezz))
                if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)) == 0 :
                    os.mkdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
            ...
            #-----------------------------------------------Mod Effect------------------------------------------------------------#
                if True:
                    ...
                    if hieu_ung == b'\x8f':
                        ...
                        for filez in listdir(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}'):
                            if filez=='skill' or filez=='Skill':
                                for file in listdir('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                                    if True:
                                        try:
                                            with open('/content/drive/My Drive/tool/Pmin_Sources/check/{}/{}'.format(skinid.decode(),file),'rb') as f:
                                                strin = f.read()
                                                if '_back.xml' in file or '_Back.xml' in file:
                                                    strin=strin.replace(b'enabled="true"',b'enabled="false"')
                                                print(Fore.GREEN+Style.BRIGHT+'File Có Skill Ẩn: '+file)
                                                check_skill_an=True
                                                list_skill_an.append(file)
                                                if HD_e:
                                                    p=strin.find(b'<String name="resourceName" value="')
                                                    while p!=-1:
                                                        p2=strin.find(b'" refParamName=""',p)
                                                        strin=strin.replace(strin[p:p2+1],strin[p:p2]+b'.prefab"',1)
                                                        p=strin.find(b'<String name="resourceName" value="',p2)
                                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:
                                                    f1.write(strin)
                                        except:
                                            with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                                strin = f.read()
                                                strin=decompress_(strin,ZSTD_DICT)
                                                if '_back.xml' in file or '_Back.xml' in file:
                                                    strin=strin.replace(b'enabled="true"',b'enabled="false"')
                                                ...
                                                if skinid[:3] == b'544' and file=='A4B1.xml':
                                                ...
                                                if skinid[:3]==b'521' and skinid!='52108' and file in ['S1B3.xml','S1B4.xml']:
                                                ...
                                                if skinid[:3]==b'524' and file =='A1E9.xml':
                                                ...
                                                if HD_e:
                                                    ...
                                                    while p!=-1:
                                                        ...
                                                        p=strin.find(b'<String name="resourceName" value="',p2)
                                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:
                                                    f1.write(fix_ef(strin,skinid))
                                    if (skinid[:3]!=b'524' and file in ['A1E1.xml','A1e1.xml','a1e1.xml']) or (skinid[:3]==b'524' and file in ['A1E6.xml','A1e6.xml','a1e6.xml']):
                                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f1:
                                            strin=f1.read()
                                            p=strin.find(b'<String name="resourceName" value="')
                                            while p!=-1:
                                                p2=strin.find(b'" refParamName=""',p)
                                                du_kien_mod_born=strin[p+len(b'<String name="resourceName" value="'):p2].lower()
                                    ...
                                    if DeAllSkin:
                                        ...
                                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f1:f1.write(text)
                                if check_skill_an:
                                    ten_de_vao_skill_an=ten_de_vao_skill_an+decompress+'\n'
                                    for i in list_skill_an:
                                        ten_de_vao_skill_an=ten_de_vao_skill_an+'\t'+i+'\n'
                            else:
                                for file in listdir(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}'):
                                    with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','rb') as f:
                                        strin = f.read()
                                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/{filez}/{file}','wb') as f1:
                                                f1.write(strin)
                    else:
                        for file in listdir('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill/'.format(decompress)):
                            if '.xml' in file:
                ...
                if hieu_ung == b'\x8f' and not DeAllSkin:
                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:
                        strin=f1.read()
                        check=b'    <Track trackName="BORN_ID_SKIN" eventType="CheckHeroIdTick" guid="Mod_by_PminMod_ID_SKIN" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      <Event eventName="CheckHeroIdTick" time="0.000" isDuration="false" guid="Mod_Vip">\r\n      <TemplateObject name="targetId" id="0" objectName="self" isTemp="false" refParamName="" useRefParam="false" />\r\n        <int name="heroId" value="ID_SKIN" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>\r\n'
                        strin=strin.replace(b'  </Action>\r\n</Project>',check.replace(b'ID_SKIN',skinid[:3])+b'  </Action>\r\n</Project>',1)
                        ef=b'    <Track trackName="PminMod" eventType="TriggerParticleTick" guid="I LOVE YOU" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      <Condition id="1" guid="Mod_by_PminMod_ID_SKIN" status="true" />\r\n      <Event eventName="TriggerParticleTick" time="0.000" isDuration="false" guid="866871db-f8fd-4577-8cb7-e0ee803ade3f">\r\n        <TemplateObject name="targetId" id="1" objectName="target" isTemp="false" refParamName="" useRefParam="false" />\r\n        <String name="resourceName" value="EFFECT" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>\r\n'
                    ...
                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
                        f1.write(strin)
            #-----------------------------------------------Mod heroSkin------------------------------------------------------------#
                try:
                    if True:
                        ...
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1:
                                ...
                                if pos !=-1:
                                    ...
                                    if skinid==b'16707':
                                        ...
                                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            f1.write(strin)
                                    elif skinid==b'10620':
                                        actor_mod=actor_mod[:4]+actor_0[4:10]+actor_mod[10:36]+b'\x00'+actor_mod[37:]
                                ...
                                if pos !=-1:
                                    ...
                                    if re_2!=b'' and actor_2!=b'' and nnn!=int(skinid[3:].decode()):
                                        ...
                                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f1:
                                            f1.write(strin)
                        try:
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                                strin = f.read()
                                hero_actor=dec_to_hex(int(skinid[:3].decode()))
                                pos = strin.find(id_2+b'\x00\x00'+hero_actor)
                                if pos !=-1:
                                    ...
                                    if pos!=-1:
                                        ...
                                        if skinid==b'13311':
                                            with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','rb') as f:
                            ...
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Shop/HeroSkinShop.bytes','wb') as f1:
                                f1.write(strin)
                        except Exception as bug:
                            print(bug)          
                            pass
            ...
            #-----------------------------------------------Mod Infos Skin Mặc Định------------------------------------------------------------#
                for file in listdir('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/'.format(decompress)):
                    with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','rb') as f:
                        a=f.read()
                        check_file3=False
                        ...
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file}','wb') as f1:
                            f1.write(a)
                thu=False
                try:
                    filexml='/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2)
                    byt=open(filexml, 'rb')
                    i=0
                    nod={}
                    ofs = getint()
                ...
                if thu:
                    try:
                        with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{file2}','rb') as f:
                            strin=f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            ...
                            if cam_skin_find!=-1:
                                ...
                                strin=strin.replace(mac_dinh,mac_dinh.replace(lod_mac_dinh,lod_skin).replace(show_mac_dinh,show_skin))
                            with open('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file2),'wb') as f1:
                                if skinid==b'54402':
                ...
                try:
                    if check_file3:
                        filexml='/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,file3)
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
            ...
            #---------------------------All Sound--------------------------
                if True:
                    ...
                    for nnn in range(1,30):
                        id_2 = dec_to_hex(int(skinid[:3].decode())*100+nnn)
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/ChatSound.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/ChatSound.bytes','wb') as f:
                                    f.write(strin)
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/HeroSound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_0+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1 and id_2!=id_mod:
                                strin = strin.replace(b'\x00'+id_2+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/HeroSound.bytes','wb') as f:
                                    f.write(strin)  
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbyBank.bytes','rb') as f:
                            strin = f.read()
                            ...
                            if pos!=-1 and id_2!=id_mod:
                                ...
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbyBank.bytes','wb') as f1:
                                    f1.write(strin)
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbySound.bytes','rb') as f:
                            strin = f.read()
                            pos = strin.find(b'\x00'+id_2 + b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                            if pos!=-1 and id_2!=id_mod:
                                strin = strin.replace(b'\x00'+id_2+b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',b'\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/LobbySound.bytes','wb') as f1:
                                    f1.write(strin)
            #-----------------------------------------------Mod HeroSkinShop------------------------------------------------------------#
                try:
                ...
                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','rb') as f:
                    ...
                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/heroSkin.bytes','wb') as f:f.write(a)
                try:
                #-----------------------------------------------Mod Sound------------------------------------------------------------#
                    if True:
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Sound/BattleBank.bytes','rb') as f:
                            ...
                            if pos!=-1:
                                for file in listdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)):
                                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                        nam_tat = f.read()
                                        pos = nam_tat.find( b'<Event eventName="PlayHeroSoundTick')
                                        sound_id = str(int(skinid[3:].decode())).encode()
                                        while pos != -1:
                                            posid = nam_tat.find(b'<String name="eventName" value="',pos)
                                            posid2 = nam_tat.find(b'" refParamName="" useRefParam="false" />',posid)
                                            code = nam_tat[posid:posid2]
                                            posid3 = code.find(b'_Skin'+sound_id)
                                            if posid3 !=-1:
                                                nam_tat = nam_tat
                                            else:
                                                if skinid!=b'13006':
                                                    nam_tat = nam_tat.replace(code,code+b'_skin'+sound_id,1)
                                                else:
                                                    nam_tat=nam_tat.replace(code,code+b'_skin5')
                                            pos = nam_tat.find( b'<Event eventName="PlayHeroSoundTick',posid)
                                        nam_tat=fix_sound(nam_tat,sound_id)
                                        anti=nam_tat
                                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','wb') as f:
                                                f.write(compress_(nam_tat,ZSTD_DICT))
            ...
            #-----------------------------------------------Mod Back------------------------------------------------------------#
                if find_back>2 or skinid in [b'15004',b'13311',b'16707']:
                    try:
                        name = b''
                        for file in listdir('/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(decompress)):
                            with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/skill/{file}','rb') as f:
                                ...
                                if skinid.decode() + '_Back.xml' == file or skinid.decode() + '_back.xml' == file:
                                    special = [b'CheckConditionDuration0',b'FilterTargetType0',b'\xE8\x8E\xAB\xE6\x89\x98\xE6\x96\xAF\xE6\x9C\xBA\xE7\x94\xB2',b'\xEF\xBB\xBF\xE6\x8A\xAC\xE9\xAB\x98',b'\xE8\x8E\xAB\xE6\x8B\x89\xE4\xBB\x99\xE4\xBE\xA0',b'CheckSkinIdTick0',b'CheckSkinIdVirtualTick0',b'\xE7\x8C\xB4\xE5\xAD\x90\x54\x32',b'\xEF\xBB\xBF\xE8\x8E\xAB\xE6\x89\x98\xE6\x96\xAF\xE6\x9C\xBA\xE7\x94\xB2',b'\xE6\x8B\x89\xE7\xBB\xB4\xE5\xB0\x94\xE6\x96\xB0\xE5\xB9\xB4',b'CheckConditionDuration0',b'\xE6\x8A\xAC\xE9\xAB\x98']
                                    for name in special:
                                        name = b'<Track trackName="'+name
                                        pos = strin.find(b'Condition')
                                        first = strin.find(name)
                                        if first!=-1 and pos!=-1:
                                            second = strin.find(b'    <Track trackName="',first)
                                            ten = strin[first:second]+b'    '
                                            strin = strin.replace(ten,b'')
                                            condition = strin.find(b'<Condition id="')
                                            while condition!=-1:
                                                delete = strin[condition+0:condition+86]
                                                strin = strin.replace(delete,b'')
                                                condition = strin.find(b'<Condition id="')
                                    pos = strin.find(b'\r\n    <Track trackName="')
                                    posid = strin.find(b'\r\n  </Action>',pos)
                                    name = strin[pos:posid]
                                    if skinid ==b'51504':
                                        name = name.replace(b'<String name="clipName" value="',b'<String name="clipName" value="51504/')
                                    if skinid==b'15412':
                                        name=name.replace(b'prefab_skill_effects/hero_skill_effects/154_HuaMuLan/',b'prefab_skill_effects/hero_skill_effects/154_HuaMuLan/15412/')
                                        name=name.replace(b'<String name="resourceName" value="born_back_reborn/huijidi_01_b" refParamName="strReturnCityFall" useRefParam="false" />',
                                        b'<String name="resourceName" value="prefab_skill_effects/hero_skill_effects/154_HuaMuLan/15412/huijidi_01_b" useRefParam="true" />').replace(b'<String name="resourceName" value="prefab_skill_effects/tongyong_effects/tongyong_hurt/born_back_reborn/huicheng_tongyong_01_b" refParamName="strReturnCityEffectPath" useRefParam="false" />',
                                        b'<String name="resourceName" value="prefab_skill_effects/hero_skill_effects/154_HuaMuLan/15412/huicheng_tongyong_01_b" useRefParam="true" />').replace(b'<String name="resourceName" value="prefab_skill_effects/Huicheng_ personality_01" refParamName="" useRefParam="false" />',
                                        b'<String name="resourceName" value="prefab_skill_effects/hero_skill_effects/154_HuaMuLan/15412/Huicheng_ personality_01" useRefParam="true" />').replace(b'62996a6c-a8d4-42f6-90aa-6ee10271d08e" enabled="false',b'62996a6c-a8d4-42f6-90aa-6ee10271d08e" enabled="true').replace(b'3965e0e3-dd4b-44b8-ba36-682488d46550" enabled="false',b'3965e0e3-dd4b-44b8-ba36-682488d46550" enabled="true')
                                    if skinid==b'15710':
                        ...
                        if True:
                            if True:
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','rb') as f:
                                    strin = f.read()
                                    if True:
                                        back_id = b'\r\n    <Track trackName="ReupCC_'+bytes(str(i),'utf-8')+b'" eventType="CheckHeroIdTick" guid="Mod_by_YOUTUBE_'+hero_name[:3]+b'" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      <Event eventName="CheckHeroIdTick" time="0.000" isDuration="false" guid="Mod_Vip">\r\n      <TemplateObject name="targetId" id="0" objectName="self" isTemp="false" refParamName="" useRefParam="false" />\r\n      <int name="heroId" value="'+hero_name[:3]+b'" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>'
                                        ...
                                        back=back_id+b'\r\n    <Track trackName="Zalo_0357514770" eventType="GetHolidayResourcePathTick" guid="Zalo_0357514770" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      Pmin_Dep_Trai\r\n      <Event eventName="GetHolidayResourcePathTick" time="7.000" isDuration="false" guid="Zalo_0357514770">\r\n        <String name="holidayResourcePathPrefix" value="Pmin_Pro_Vip/huijidi_01" refParamName="" useRefParam="false" />\r\n        <String name="outPathParamName" value="strReturnCityFall" refParamName="" useRefParam="false" />\r\n        <String name="outSoundEventParamName" value="" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>\r\n    <Track trackName="Zalo_0357514770" eventType="GetHolidayResourcePathTick" guid="Zalo_0357514770" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      Pmin_Dep_Trai\r\n      <Event eventName="GetHolidayResourcePathTick" time="0.000" isDuration="false" guid="Zalo_0357514770">\r\n        <String name="holidayResourcePathPrefix" value="Pmin_Pro_Vip/huicheng_tongyong_01" refParamName="" useRefParam="false" />\r\n        <String name="outPathParamName" value="strReturnCityEffectPath" refParamName="" useRefParam="false" />\r\n        <String name="outSoundEventParamName" value="" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>\r\n    <Track trackName="Zalo_0357514770" eventType="TriggerParticleTick" guid="Zalo_0357514770" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      Pmin_Dep_Trai\r\n      <Event eventName="TriggerParticleTick" time="7.000" isDuration="false" guid="Zalo_0357514770">\r\n        <TemplateObject name="targetId" id="-1" objectName="None" isTemp="false" refParamName="" useRefParam="false" />\r\n        <TemplateObject name="objectSpaceId" id="0" objectName="self" isTemp="false" refParamName="" useRefParam="false" />\r\n        <String name="resourceName" value="" refParamName="strReturnCityFall" useRefParam="true" />\r\n        <float name="lifeTime" value="5.000" refParamName="" useRefParam="false" />\r\n        <Vector3i name="scalingInt" x="10000" y="10000" z="10000" refParamName="" useRefParam="false" />\r\n        <bool name="bUseHeroLocalForward" value="true" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>\r\n    <Track trackName="Zalo_0357514770" eventType="TriggerParticle" guid="Zalo_0357514770" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      Pmin_Dep_Trai\r\n      <Event eventName="TriggerParticle" time="0.000" length="7.000" isDuration="true" guid="Zalo_0357514770">\r\n        <TemplateObject name="targetId" id="0" objectName="self" isTemp="false" refParamName="" useRefParam="false" />\r\n        <TemplateObject name="objectSpaceId" id="0" objectName="self" isTemp="false" refParamName="" useRefParam="false" />\r\n        <String name="resourceName" value="" refParamName="strReturnCityEffectPath" useRefParam="true" />\r\n        <Vector3 name="bindPosOffset" x="0.000" y="-0.300" z="0.000" refParamName="" useRefParam="false" />\r\n        <Vector3i name="scalingInt" x="10000" y="10000" z="10000" refParamName="" useRefParam="false" />\r\n        <bool name="bEnableOptCull" value="false" refParamName="" useRefParam="false" />\r\n        <bool name="bTrailProtect" value="true" refParamName="" useRefParam="false" />\r\n        <String name="syncAnimationName" value="" refParamName="" useRefParam="false" />\r\n        <bool name="bApplySpecialEffect" value="true" refParamName="" useRefParam="false" />\r\n        <bool name="bOnlySetAlpha" value="true" refParamName="" useRefParam="false" />\r\n        <String name="customTagName" value="" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>\r\n    <Track trackName="Zalo_0357514770" eventType="StopTracks" guid="Zalo_0357514770" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      Pmin_Dep_Trai\r\n      <Event eventName="StopTracks" time="0.000" isDuration="false" guid="Zalo_0357514770">\r\n        <Array name="trackIds" refParamName="" useRefParam="false" type="TrackObject">'+stoptrack_code+b'\r\n        </Array>\r\n        <bool name="alsoStopNotStartedTrack" value="true" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>'
                                        back=back.replace(b'Pmin_Dep_Trai',condition_mod).replace(b'Pmin_Pro_Vip',ef)
                                        back_need_2=back_need_
                                        if skinid in [b'50604',b'15004',b'51504',b'13311']:
                                        ...
                                        strin = strin.replace(b'\r\n  </Action>',back+name+back_need_2.replace(b'<Event eventName="PlayAnimDuration"',condition_mod+b'\r\n      <Event eventName="PlayAnimDuration"')+b'\r\n  </Action>')
                                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','wb') as f1:
                                            f1.write(strin)
                        zz+=1;i+=1;j+=1
                    except Exception as bug:
                        print(bug)
            ...
            #-----------------------------------------------Mod LiteBullet------------------------------------------------------------#
                if skinid==b'15009':
                    for file in ['BlueBuff.xml','RedBuff_Slow.xml']:
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','rb') as f:
                            a=f.read()
                            a=a.replace(b'CheckSkinIdVirtualTick',b'CheckHeroIdTick').replace(b'skinId" value="15009',b'heroId" value="150')
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/PassiveResource/{file}','wb') as f:
                            f.write(a)
    #------------------------mod ăn bùa nak----------------------
                if skinid==b'15013':
                    ...
                    for file in ['Dead_Born.xml']:
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','rb') as f:
                            a=f.read()
                        ...
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/{file}','wb') as f:
                            f.write(a)
    #------------------------mod ăn bùa nak----------------------
                def mod_lite(folder_mod,hero_name,skinid):
                    try:
                        
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:
                            strin = f.read()
                            k=0
                                        ...
                                        if pos!=-1:
                                            ...
                                            if pos!=-1:
                                                ...
                                                if pos!=-1:
                                                    ...
                                                    a=a.replace(a,dau+a[1:])
                                                    strin = strin.replace(re_a,a)
                                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f1:
                                            f1.write(strin)
                                        k+=1
                    except:
                        print(Fore.RED+Style.BRIGHT+'Không Mod Đánh Thường'+Style.RESET_ALL)
                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','rb') as f:a=f.read()
                if b'/'+skinid[:3]+b'_' in a and hieu_ung==b'\x8f':
                    if skinid!=b'13311':
                        ...
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/liteBulletCfg.bytes','wb') as f:f.write(a)
            #-----------------------------------------------Mod Skill Mark------------------------------------------------------------#
                try:
                    
                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/skillmark.bytes','rb') as f:
                        a=f.read()
                        if b's/'+skinid[:3]+b'_' in a or b'S/'+skinid[:3]+b'_' in a:
                            a=skillmark(a,skinid)
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Skill/skillmark.bytes','wb') as f1:
                            f1.write(a)
                except:
                    print(Fore.RED+Style.BRIGHT+'Không Mod skillmark'+Style.RESET_ALL)
                if skinid==b'13311':
                    inp = f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/'
                ...
                try:
                    if True:
                        if skinid[:3] not in [b'150',b'106',b'131',b'510',b'136',b'524']:
                            DIR = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                            DIR2 = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/skill'.format(folder_mod,decompress)
                            nonee = './{}/skill'.format(decompress)
                            with zipfile.ZipFile('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/Actor_{}_Actions.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        else:
                            def zipdir4(path, ziph):
                                for ii in listdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{decompress}/'):
                                    nonee = f'./{decompress}/{ii}'
                                    DIR = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                    DIR2 = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}/{}'.format(folder_mod,decompress,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in listdir(DIR2):
                                            ziph.write(os.path.join(root, file),
                                                    os.path.relpath(os.path.join(nonee,file),
                        ...
                        if skinid[:3]==b'526' or skinid[:3]==b'137':
                            os.mkdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}')
                            os.mkdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}_pet')
                            with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/Prefab_Characters/Prefab_Pet/{decompress}_Pet/{decompress}_Pet_actorinfo.bytes','rb') as f:a=f.read()
                            if skinid[:3]==b'526':
                                a=decompress_(a,ZSTD_DICT)
                            ...
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}_pet/{decompress}_Pet_actorinfo.bytes','wb') as f:f.write(a)
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{decompress}/{decompress}_actorinfo.bytes','rb') as f:
                                a=f.read()
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{decompress}/{decompress}_actorinfo.bytes','wb') as f:
                                    f.write(a)
                            def zipdir3(path, ziph):
                                for ii in [decompress,f'{decompress}_pet']:
                                    nonee = './{}'.format(ii)
                                    DIR2 = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    DIR = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{}'.format(folder_mod,ii)
                                    for root, dirs, files in os.walk(DIR):
                                        for file in listdir(DIR2):
                                            ziph.write(os.path.join(root, file),
                                                    os.path.relpath(os.path.join(nonee,file),
                                                                    os.path.join(path, '..')))
                            with zipfile.ZipFile('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,decompress[:3]), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir3('tmp/', zipf)
                            for file in listdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/'):
                                if 'bytes' not in file:
                                    shutil.rmtree(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/{file}')
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            DIR = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            DIR2 = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress)
                            nonee = './Prefab_Hero/{}'.format(decompress)
                            with zipfile.ZipFile('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Actor_{}_Infos.pkg.bytes'.format(folder_mod,hero_name[:3].decode()), 'w', zipfile.ZIP_STORED) as zipf:
                                zipdir('tmp/', zipf)
                        if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))== 1 :
                            shutil.rmtree('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,decompress))
                        if skinid[:3]!=b'526' and skinid[:3]!=b'137':
                            if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))== 1 :
                                shutil.rmtree('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Prefab_Characters/Prefab_Hero'.format(folder_mod))
                except:pass
            #----------------------------------Mod Motion--------------------------------------------#
                try:
                    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','rb') as f:
                        strin=f.read()
                        ID=skinid.decode()
                        List=[]
                        for i in range(30):
                        ...
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Motion/ResSkinMotionBaseCfg.bytes','wb') as f:f.write(strin)
                except:
                    print('\033[1;33mKhong Mod Motion')
                if skinid in [b'54402']:
                    try:
                        with open('Prefab_Gear.pkg.bytes','rb') as f:
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear.pkg.bytes','wb') as f1:
                                f1.write(f.read())
                    except:
                        if os.path.isdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear')== 0 :
                            shutil.copytree(f'/content/drive/My Drive/tool/Pmin_Sources/resources/1.57.1/ages/prefab_gear',f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear')
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear/Defense/1338E1.xml','rb') as f:
                            strin=f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            ...
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Gear/Defense/1338E1.xml','wb') as f:
                                f.write(fix_condition(strin))
                #----------------------------------Mod Haste--------------------------------------------#
                try:
                    if find_back>2:
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f:
                            strin = f.read()
                            ef = b'   <Track trackName="CheckHeroIdTick'+bytes(str(has),'utf-8')+b'" eventType="CheckHeroIdTick" guid="Mod_by_YOUTUBE'+hero_name[3:]+b'" enabled="true" refParamName="" useRefParam="false" r="0.667" g="1.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      <Event eventName="CheckHeroIdTick" time="0.000" isDuration="false">\r\n        <TemplateObject name="targetId" objectName="target" id="1" isTemp="false" refParamName="" useRefParam="false"/>\r\n        <int name="heroId" value="'+skinid[:3]+b'" refParamName="" useRefParam="false"/>\r\n      </Event>\r\n    </Track>\r\n    <Track trackName="TriggerParticle0" eventType="TriggerParticle" guid="IDSKIN_Mod_by_YOUTUBE" enabled="true" useRefParam="false" refParamName="" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      <Condition id="pmin" guid="Mod_by_YOUTUBE'+hero_name[3:]+b'" status="true" />\r\n      <Event eventName="TriggerParticle" time="0.000" length="5.000" isDuration="true" guid="3f4a326c-6b74-4d7e-b9ac-f36378e06052">\r\n        <TemplateObject name="targetId" objectName="target" id="1" isTemp="false" refParamName="" useRefParam="false" />\r\n        <TemplateObject name="objectSpaceId" objectName="target" id="1" isTemp="false" refParamName="" useRefParam="false" />\r\n        <uint name="RefLiteBulletID" value="0" refParamName="" useRefParam="false" />\r\n        <bool name="bChooseResourceNameByCamp" value="false" refParamName="" useRefParam="false" />\r\n        <String name="parentResourceName" value="" refParamName="" useRefParam="false" />\r\n        <String name="resourceName" value="prefab_skill_effects/hero_skill_effects/'+hero_name+b'/'+skinid+b'/jiasu_tongyong_01" refParamName="" useRefParam="false" />\r\n        <Vector3 name="bindPosOffset" x="0.000" y="0.700" z="-0.600" refParamName="" useRefParam="false" />\r\n      </Event>\r\n    </Track>' 
                            ...
                            if pos!=-1:
                                ...
                                with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
                                    f1.write(strin)
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f:
                            strin = f.read()
                            ef = b'   <Track trackName="CheckHeroIdTick'+bytes(str(has),'utf-8')+b'" eventType="CheckHeroIdTick" guid="Mod_by_YOUTUBE'+hero_name[3:]+b'" enabled="true" refParamName="" useRefParam="false" r="0.667" g="1.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      <Event eventName="CheckHeroIdTick" time="0.000" isDuration="false">\r\n        <TemplateObject name="targetId" objectName="target" id="1" isTemp="false" refParamName="" useRefParam="false"/>\r\n        <int name="heroId" value="'+skinid[:3]+b'" refParamName="" useRefParam="false"/>\r\n      </Event>\r\n    </Track>\r\n    <Track trackName="TriggerParticle0" eventType="TriggerParticle" guid="IDSKIN_Mod_by_YOUTUBE" enabled="true" refParamName="" useRefParam="false" r="0.000" g="0.000" b="0.000" execOnForceStopped="false" execOnActionCompleted="false" stopAfterLastEvent="true">\r\n      <Condition id="'+bytes(str(hasteE1_leave),'utf-8')+b'" guid="Mod_by_YOUTUBE'+hero_name[3:]+b'" status="true" />\r\n      <Event eventName="TriggerParticle" time="0.000" length="5.000" isDuration="true">\r\n        <TemplateObject name="targetId" objectName="target" id="1" isTemp="false" refParamName="" useRefParam="false"/>\r\n        <TemplateObject name="objectSpaceId" objectName="target" id="1" isTemp="false" refParamName="" useRefParam="false"/>\r\n        <uint name="RefLiteBulletID" value="0" refParamName="" useRefParam="false"/>\r\n        <bool name="bChooseResourceNameByCamp" value="false" refParamName="" useRefParam="false"/>\r\n        <String name="parentResourceName" value="" refParamName="" useRefParam="false"/>\r\n        <String name="resourceName" value="prefab_skill_effects/hero_skill_effects/'+hero_name+b'/'+skinid+b'/jiasu_tongyong_01" refParamName="" useRefParam="false"/>\r\n        <Vector3 name="bindPosOffset" x="0.000" y="0.700" z="-0.600" refParamName="" useRefParam="false"/>\r\n      </Event>\r\n    </Track>'
                            ...
                            if skinid==b'13210':
                                ef=ef.replace(b'CheckHeroIdTick',b'CheckSkinIdTick').replace(b'heroId" value="'+skinid[:3],b'skinId" value="'+skinid[:3]+b'00')
                            strin = strin.replace(b' </Action>',ef+b'\n  </Action>')
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
                                f1.write(strin)
                except:
                ...
                try:
                    if skinid[:3] in [b'150']:
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
                            killboard=f.read()
                        ...
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','wb') as f:
                            f.write(killboard)
                except Exception as bug:
                    print(bug)
                #Mod assetrefs
                ...
                try:
                    if skinid==b'52414':   
                        ...
                        with open(f'/content/drive/My Drive/tool/Pmin_Sources/Resources/1.57.1/AssetRefs/Hero/{file}','rb') as f:
                            strin = f.read()
                            strin=decompress_(strin,ZSTD_DICT)
                            if os.path.isdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/') ==0:
                                os.makedirs(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/')
                                os.makedirs(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/')
                            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}','wb') as f1:
                                f1.write(strin)
                        filexml=f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/AssetRefs/Hero/{file}'
                        byt=open(filexml, 'rb')
                        i=0
                        nod={}
                        ofs = getint()
         ...
         <Item Var="Com" Type="AssetRefAnalyser.Pair`2[System.UInt32,System.Int32]">
            ...
            <v2 Var="String" Type="System.Int32">1</v2>
                        ...
                        f.close()
                    if skinid==b'15009':
                        with open('/content/drive/My Drive/tool/organSkin.bytes','rb') as f:
                            a=f.read()
                        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Actor/organSkin.bytes','wb') as f1:
                                    f1.write(a)
                except Exception as bug:
                    print(bug)
    def zipdir2(path, ziph):
        for ii in back_folder:
            nonee = './{}'.format(ii)
            DIR2 = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            DIR = '/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,ii)
            for root, dirs, files in os.walk(DIR):
                for file in listdir(DIR2):
                    ziph.write(os.path.join(root, file),
                            os.path.relpath(os.path.join(nonee,file),
                                            os.path.join(path, '..')))
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','rb') as f1:strin=f1.read()
    ...
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','rb') as f1:strin=f1.read()
    if raz_15710_back:
    ...
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','rb') as f1:strin=f1.read()
    if False:
    ...
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/HasteE1_leave.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','rb') as f1:strin=f1.read()
    strin=fix_condition(strin)
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Born.xml','wb') as f1:
        f1.write(compress_(strin,ZSTD_DICT))
    with zipfile.ZipFile('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes'.format(folder_mod), 'w', zipfile.ZIP_STORED) as zipf:
        zipdir2('tmp/', zipf)
    ten_de_vao_ten=ten_de_vao_ten.encode('utf-8')
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/list.txt','wb') as f:f.write(ten_de_vao_ten)

    ten_de_vao_skill_an=ten_de_vao_skill_an.encode('utf-8')
    with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/skill_an(checkskinidtick).txt','wb') as f:f.write(ten_de_vao_skill_an)
    for iii in back_folder:
        if os.path.isdir('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))== 1 :
            shutil.rmtree('/content/drive/My Drive/tool/File_Mod/{}/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{}'.format(folder_mod,iii))
    #---------mod ResCharacterComponent.bytes-----
    try:
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Character/ResCharacterComponent.bytes','rb') as f:
            a=f.read()
            p2=a[:14]
            p3=a[:12]+b'\x00\x00'
            a=a.replace(p2,p3,1)
            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Character/ResCharacterComponent.bytes','wb') as f:f.write(compress_(a,ZSTD_DICT))
    except:
        print('\033[1;33mKhong Mod ResCharacterComponent.bytes')
    try:
        nut_bam=sys.argv[5]
        nut_bam=int(nut_bam)
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResPersonalButtonCfg.bytes','rb') as f:
            a=f.read()
            a=a.replace(dec_to_hex(15711)+b'\x00\x00',dec_to_hex(15700)+b'\x00\x00')
            a=a.replace(dec_to_hex(nut_bam)+b'\x00\x00',dec_to_hex(15711)+b'\x00\x00')
            a=a.replace(dec_to_hex(15700)+b'\x00\x00',dec_to_hex(nut_bam)+b'\x00\x00')
            c,b=ten_skin_hieu_ung(nut_bam)
            print('Đã Mod Nút Bấm Raz Gon Thành Nút Bấm',b)
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResPersonalButtonCfg.bytes','wb') as f:
            f.write(a)
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','rb') as f:
            a=f.read()
            inp=nut_bam
            if inp==51015:
                a=a.replace(b'/10/',b'/23/')
            if inp==59702:
                a=a.replace(b'/10/',b'/24/')
            if inp==15015:
                a=a.replace(b'/10/',b'/20/')
            if inp==15412:
                a=a.replace(b'/10/',b'/11/')
            if inp==13015:
                a=a.replace(b'/10/',b'/12/')
            if inp==13116:
                a=a.replace(b'/10/',b'/13/')
            if inp==52011:
                a=a.replace(b'/10/',b'/15/')
            if inp==15013:
                a=a.replace(b'/10/',b'/16/')
            if inp==10620:
                a=a.replace(b'/10/',b'/19/')
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn/files/Resources/1.57.1/Databin/Client/Huanhua/ResKillBillboardCfg.bytes','wb') as f:
            f.write(a)
    except Exception as bug:
        pass
    ...
    if cam_xa_goc!=110:
        ...
        if os.path.isdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%') == 0 :
            os.mkdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%')
        shutil.copytree(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/com.garena.game.kgvn',f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn')
        try:
            giai_nen(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/','Actor_530_Actions.pkg.bytes')
        except:
            shutil.copytree(f'/content/drive/My Drive/tool/Pmin_Sources/resources/1.57.1/ages/Prefab_Characters/Prefab_Hero/530_Dirak',f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        ...
        giai_nen(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/','CommonActions.pkg.bytes')
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            p=a.find(b'    <Track trackName="')
            a=a[:p]+cam_xa
            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill/P2E1.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Back.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/born.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal5v5.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','rb') as f:
            a=f.read()
            a=decompress_(a,ZSTD_DICT)
            a=a.replace(b'  </Action>',hittringer_dirak)
            with open(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/commonresource/Heal3v3.xml','wb') as f:f.write(compress_(a,ZSTD_DICT))
        DIR = f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        DIR2 = f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak/skill'
        nonee = './530_Dirak/skill'
        with zipfile.ZipFile(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/Actor_530_Actions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir('tmp/', zipf)
        def zipdir_camxa(path, ziph):
            for ii in back_folder:
                nonee = './{}'.format(ii)
                DIR2 = f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                DIR = f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{ii}'
                for root, dirs, files in os.walk(DIR):
                    for file in listdir(DIR2):
                        ziph.write(os.path.join(root, file),
                                os.path.relpath(os.path.join(nonee,file),
                                                os.path.join(path, '..')))
        with zipfile.ZipFile(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/CommonActions.pkg.bytes', 'w', zipfile.ZIP_STORED) as zipf:
            zipdir_camxa('tmp/', zipf)
        if os.path.isdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')== 1 :
            shutil.rmtree(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/530_Dirak')
        for iii in back_folder:
            if os.path.isdir(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')== 1 :
                shutil.rmtree(f'/content/drive/My Drive/tool/File_Mod/{folder_mod}/CAM XA {cam_xa_goc}%/com.garena.game.kgvn/files/Resources/1.57.1/Ages/Prefab_Characters/Prefab_Hero/{iii}')